...
#   './single_objective/styblinski_tang/graph.py'
...
#write out plot
plotname = "styblinski_tang_plots.png"
...
ax1.set_title('Styblinski-Tang: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Styblinski-Tang: Contour Plot of Solution Space', fontsize = 15)
