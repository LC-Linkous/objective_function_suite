...
#   './single_objective/rastrigin/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.rastrigin.func_F import func_F
    from single_objective.rastrigin.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "rastrigin.func_F"
CONSTR_FUNC_NAME = "rastrigin.constr_F"
