...
#   './single_objective/sphere/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.sphere.func_F import func_F
    from single_objective.sphere.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "sphere.func_F"
CONSTR_FUNC_NAME = "sphere.constr_F"
