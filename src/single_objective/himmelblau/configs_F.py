...
#   './single_objective/himmelblau/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.himmelblau.func_F import func_F
    from single_objective.himmelblau.constr_F import constr_F
except: # for local
