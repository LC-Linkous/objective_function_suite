...
#   './single_objective/himmelblau/graph.py'
...
ax1.set_title('Himmelblau: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Himmelblau: Contour Plot of Solution Space', fontsize = 15)
