...
#   './single_objective/cross_in_tray/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.cross_in_tray.func_F import func_F
    from single_objective.cross_in_tray.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "cross_in_tray.func_F"
CONSTR_FUNC_NAME = "cross_in_tray.constr_F"
