...
#   './single_objective/cross_in_tray/graph.py'
...
#write out plot
plotname = "cross_in_tray_plots.png"
...
ax1.set_title('Cross-in-Tray: 3D Projection of Solution Space')
...
ax2.set_xlabel('$x_1$')
ax2.set_ylabel('$x_2$')
ax2.set_title('Cross-in-Tray: Contour Plot of Solution Space')
