...
#   './single_objective/booth/graph.py'
...
ax1.set_title('Booth: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Booth: Contour Plot of Solution Space', fontsize = 15)
