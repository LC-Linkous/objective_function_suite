...
#   './single_objective/levy_N13/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.levy_N13.func_F import func_F
    from single_objective.levy_N13.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "levy_N13.func_F"
CONSTR_FUNC_NAME = "levy_N13.constr_F"
