...
#   './single_objective/rosenbrock/graph.py'
...
ax1.set_title('Rosenbrock: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Rosenbrock: Contour Plot of Solution Space', fontsize = 15)
