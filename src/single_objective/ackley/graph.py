...
#   './single_objective/ackley/graph.py'
...
ax1.set_title('Ackley: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Ackley: Contour Plot of Solution Space', fontsize = 15)
