...
#   './constrained_objective/rosenbrock_cubic_and_line/graph.py'
...
# export plot
plotname = "rosenbrock_cubic_and_line_plots.png"
...
ax1.set_title('Multi Constrained Rosenbrock: 3D Projection of Solution Space')
...
ax2.set_xlabel('$x_1$')
ax2.set_ylabel('$x_2$')
ax2.set_title('Multi Constrained Rosenbrock: Contour Plot of Solution Space')
