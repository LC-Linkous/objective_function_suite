...
#   './single_objective_single_input/one_input_schwefel/graph.py'
...
#write out plot
plotname = "one_input_schwefel_plots.png"
...
ax1.set_title('Schwefel: 1D Objective Function Solution Space',
              fontsize=15)
