...
#   './single_objective_single_input/one_input_griewank/graph.py'
...
#write out plot
plotname = "one_input_griewank_plots.png"
...
ax1.set_title('Griewank: 1D Objective Function Solution Space',
              fontsize=15)
