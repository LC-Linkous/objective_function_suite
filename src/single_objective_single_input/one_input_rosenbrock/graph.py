...
#   './single_objective_single_input/one_input_rosenbrock/graph.py'
...
#write out plot
plotname = "one_input_rosenbrock_plots.png"
...
ax1.set_title('Rosenbrock: 1D Objective Function Solution Space',
              fontsize=15)
