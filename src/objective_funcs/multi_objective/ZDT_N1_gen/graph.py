...
#   '.src/objective_funcs/multi_objective/zitzler_deb_thiele_N1_gen/graph.py'
#   generates graphs for function based on constraints and configurations
#
#   This uses the general version of the function with 1-30 dimensions.
#   only the objective space and pareto fronts are graphed.
#
...
# The ZDT 1 function can be used for 1:n variables.
MIN_DIM = 1
MAX_DIM = 6 # No given upper limit
NUM_SAMPLES = 6
NUM_DIENSIONS = np.linspace(MIN_DIM, MAX_DIM, NUM_SAMPLES)
NUM_ROW = 2  # For subplots
NUM_COL = 3  # For subplots
NUM_POINTS = 25 # Number of points for each dimension

#for exporting df to csv
filename = 'ZDT1_pareto_coords_output.csv'
plotname = 'ZDT1_output.png'
