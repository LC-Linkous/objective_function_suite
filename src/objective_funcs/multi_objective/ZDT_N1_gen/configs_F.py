...
#   '.src/objective_funcs/multi_objective/ZDT_N1_gen/configs_F.py'
...
try: # for outside func calls
    ...
    from objective_funcs.multi_objective.ZDT_N1_gen.func_F import func_F
    from objective_funcs.multi_objective.ZDT_N1_gen.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "ZDT_N1_gen.func_F"
CONSTR_FUNC_NAME = "ZDT_N1_gen.constr_F"
