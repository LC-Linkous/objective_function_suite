...
#   './multi_objective/ctp1_2_vars/graph.py'
...
filename = 'CTP2vars_pareto_coords_output.csv'
plotname = 'ctp1_2_vars_plots.png'
...
ax1.set_title('CTP1: Feasible Decision Space', fontsize = 15)
...
ax2.set_title('CTP1: Pareto Front & Feasible Objective Space', fontsize = 15)
