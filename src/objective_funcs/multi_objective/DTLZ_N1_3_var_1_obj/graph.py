...
filename = 'DTLZ_N1_3_var_1_obj_pareto_coords_output.csv'
plotname = 'DTLZ_N1_3_var_1_obj_plots.png'
...
pareto = pareto_front(paretoCoords)
...
ax1.set_title('DTLZ N1: 3 Input Feasible Decision Space', fontsize = 15)
