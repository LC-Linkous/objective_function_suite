...
#   '.src/objective_funcs/multi_objective/poloni_2_obj/graph.py'
...
filename = 'P2obj_pareto_coords_output.csv'
plotname = 'poloni_2_obj_plots.png'
...
ax1.set_title('Poloni 2 Obj: Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Poloni 2 Obj: Pareto Front & Feasible Objective Space', fontsize = 15)
