...
#   '.src/objective_funcs/multi_objective/zitzler_deb_thiele_N1_3_var/graph.py'
...
filename = 'ZDT_N1_3var_pareto_coords_output.csv'
plotname = 'zitzler_deb_thiele_N1_plots_3_var.png'
