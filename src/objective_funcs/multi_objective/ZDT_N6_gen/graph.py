...
#   '.src/objective_funcs/multi_objective/ZDT_N6_gen/graph.py'
...
# The ZDT_N6 function can be used for 1:10 variables.
MIN_DIM = 1
MAX_DIM = 3
NUM_SAMPLES = 3
...
filepath = "ZDT6_pareto_coords_output.csv"
plotname = "ZDT6_output.png"
