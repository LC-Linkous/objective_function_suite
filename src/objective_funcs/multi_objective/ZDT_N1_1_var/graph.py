...
#   '.src/objective_funcs/multi_objective/ZDT_N1_1_var/graph.py'
...
# problem constraints - pulled from the function configs for the optimizersz
...
filename = 'ZDT_N1_1var_pareto_coords_output.csv'
plotname = 'zitzler_deb_thiele_N1_plots_1_var.png'
...
yfiller = np.zeros(len(validCoords))
decision_space = ax1.scatter(validCoords, yfiller, marker='o', color='darkslateblue')
ax1.set_xlabel('$x_1$', fontsize = 10)
ax1.set_ylabel('Filler Values', fontsize = 10)
ax1.set_title('ZDT N.1: 1 Input Feasible Decision Space', fontsize = 15)
...
ax2.set_xlabel('$f_{1}(x)$', fontsize = 10)
ax2.set_ylabel('$f_{2}(x)$', fontsize = 10)
ax2.set_title('ZDT N.1: Pareto Front & Feasible Objective Space', fontsize = 10)
