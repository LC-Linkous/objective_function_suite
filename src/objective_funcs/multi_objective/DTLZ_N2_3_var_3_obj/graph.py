...
#   '.src/objective_funcs/multi_objective/DTLZ_N2_3_var_3_obj/graph.py'
...
filename = 'DTLZ_N2_3_var_3_obj_pareto_coords_output.csv'
plotname = 'DTLZ_N2_3_var_3_obj_plots.png'
