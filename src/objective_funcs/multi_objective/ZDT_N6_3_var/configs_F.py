...
#   '.src/objective_funcs/multi_objective/ZDT_N6_3_var/configs_F.py'
...
try: # for outside func calls
    ...
    from objective_funcs.multi_objective.ZDT_N6_3_var.func_F import func_F
    from objective_funcs.multi_objective.ZDT_N6_3_var.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "ZDT_N6_3_var.func_F"
CONSTR_FUNC_NAME = "ZDT_N6_3_var.constr_F"
