...
try: # for outside func calls
    ...
    from antennacat_set.antennacat_function_2.func_F import func_F
    from antennacat_set.antennacat_function_2.constr_F import constr_F
...
OBJECTIVE_FUNC_NAME = "antennacat_func2_1_in_1_out.func_F"
CONSTR_FUNC_NAME = "antennacat_func2_1_in_1_out.constr_F"
...
GLOBAL_MIN = [[0.54724561]]       # Global minima sample, if they exist. F(x) = -0.8015825493161898