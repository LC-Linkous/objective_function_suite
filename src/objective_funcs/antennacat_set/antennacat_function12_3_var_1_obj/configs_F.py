...
try: # for outside func calls
    ...
    from antennacat_set.antennacat_function12_3_var_1_obj.func_F import func_F
    from antennacat_set.antennacat_function12_3_var_1_obj.constr_F import constr_F
...
OBJECTIVE_FUNC_NAME = "antennacat_func12_3_in_1_out.func_F"
CONSTR_FUNC_NAME = "antennacat_func12_3_in_1_out.constr_F"
