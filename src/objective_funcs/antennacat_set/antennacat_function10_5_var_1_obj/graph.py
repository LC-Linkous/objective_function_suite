...
filename = 'function10_5_var_1_obj_pareto_coords_output.csv'
plotname = 'function10_5_var_1_obj_plots.png'
...
ax1.set_title('Function 10: 5 Input (Reduced 3D) Feasible Decision Space', fontsize = 15)
