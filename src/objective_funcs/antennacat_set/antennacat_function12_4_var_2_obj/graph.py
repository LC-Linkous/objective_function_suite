...
filename = 'antennacat_function12_4_var_2_obj_pareto_coords_output.csv'
plotname = 'antennacat_function12_4_var_2_obj_plots.png'
...
ax1.set_title('Function 12: 4 Input (Reduced 3D) Feasible Decision Space', fontsize = 15)
