...
filename = 'antennacat_function10_3_var_2_obj_pareto_coords_output.csv'
plotname = 'antennacat_function10_3_var_2_obj_plots.png'
...
ax1.set_title('Function 10: 3 Input Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Function 10: Pareto Front & Feasible Objective Space')
