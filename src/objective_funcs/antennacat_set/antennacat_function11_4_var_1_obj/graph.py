...
NUM_POINTS = 35 # Number of points for each dimension


# for exporting df to csv
filename = 'antennacat_function11_4_var_1_obj_pareto_coords_output.csv'
plotname = 'antennacat_function11_4_var_1_obj_plots.png'
...
ax1.set_title('Function 11: 4 Input (Reduced 3D) Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Function 11: 1 Output Feasible Objective Space', fontsize = 15)
