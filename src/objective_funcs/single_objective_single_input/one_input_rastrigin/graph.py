...
#   './single_objective_single_input/one_input_rastrigin/graph.py'
...
#write out plot
plotname = "one_input_rastrigin_plots.png"
...
ax1.set_title('Rastrigin: 1D Objective Function Solution Space',
              fontsize=15)
