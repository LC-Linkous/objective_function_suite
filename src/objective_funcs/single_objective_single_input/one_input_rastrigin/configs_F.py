...
#   './single_objective_single_input/one_input_rastrigin/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective_single_input.one_input_rastrigin.func_F import func_F
    from single_objective_single_input.one_input_rastrigin.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "one_input_rastrigin.func_F"
CONSTR_FUNC_NAME = "one_input_rastrigin.constr_F"
