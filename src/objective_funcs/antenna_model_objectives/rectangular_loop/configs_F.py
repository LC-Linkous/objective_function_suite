...
#   './antenna_model_objectives/rectangular_loop/configs_F.py'
...
try: # for outside func calls
    ...
    from antenna_model_objectives.rectangular_loop.func_F import func_F
    from antenna_model_objectives.rectangular_loop.constr_F import constr_F
except: # for local
