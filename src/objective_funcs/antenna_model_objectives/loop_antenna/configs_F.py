...
#   './antenna_model_objectives/loop_antenna/configs_F.py'
...
try: # for outside func calls
    ...
    from antenna_model_objectives.loop_antenna.func_F import func_F
    from antenna_model_objectives.loop_antenna.constr_F import constr_F
except: # for local
