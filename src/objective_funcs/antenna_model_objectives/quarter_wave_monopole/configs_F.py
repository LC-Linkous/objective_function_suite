...
#   './antenna_model_objectives/quarter_wave_monopole/configs_F.py'
...
try: # for outside func calls
    ...
    from antenna_model_objectives.quarter_wave_monopole.func_F import func_F
    from antenna_model_objectives.quarter_wave_monopole.constr_F import constr_F
except: # for local
