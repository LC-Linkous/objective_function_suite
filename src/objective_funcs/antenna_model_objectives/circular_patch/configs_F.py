...
#   './antenna_model_objectives/circular_patch/configs_F.py'
...
try: # for outside func calls
    ...
    from antenna_model_objectives.circular_patch.func_F import func_F
    from antenna_model_objectives.circular_patch.constr_F import constr_F
except: # for local
