...
#   './single_objective/sphere/graph.py'
...
ax1.set_title('Sphere: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Sphere: Contour Plot of Solution Space', fontsize = 15)
