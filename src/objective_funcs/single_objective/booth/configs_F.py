...
#   './single_objective/booth/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.booth.func_F import func_F
    from single_objective.booth.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "booth.func_F"
CONSTR_FUNC_NAME = "booth.constr_F"
...
GLOBAL_MIN = [[1, 3]]     # Global minima, if they exist 
