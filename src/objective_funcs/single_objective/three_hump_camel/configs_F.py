...
#   './single_objective/three_hump_camel/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.three_hump_camel.func_F import func_F
    from single_objective.three_hump_camel.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "three_hump_camel.func_F"
CONSTR_FUNC_NAME = "three_hump_camel.constr_F"
