...
#   './single_objective/eggholder/graph.py'
...
#write out plot
plotname = "eggholder_plots.png"


# Define range and step size
x = np.linspace(LB_x, UB_x, 1000)
y = np.linspace(LB_y, UB_y, 1000)
X, Y = np.meshgrid(x, y)
...
ax1.set_title('Eggholder: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Eggholder: Contour Plot of Solution Space', fontsize = 15)
