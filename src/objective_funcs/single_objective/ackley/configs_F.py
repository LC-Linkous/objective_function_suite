...
#   './single_objective/ackley/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.ackley.func_F import func_F
    from single_objective.ackley.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "ackley.func_F"
CONSTR_FUNC_NAME = "ackley.constr_F"
