...
#   './single_objective/matyas/configs_F.py'
...
try: # for outside func calls
    ...
    from single_objective.matyas.func_F import func_F
    from single_objective.matyas.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "matyas.func_F"
CONSTR_FUNC_NAME = "matyas.constr_F"
