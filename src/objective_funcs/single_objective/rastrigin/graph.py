...
#   './single_objective/rastrigin/graph.py'
...
ax1.set_title('Rastrigin: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Rastrigin: Contour Plot of Solution Space', fontsize = 15)
