...
#   './single_objective/bukin_N6/graph.py'
...
ax1.set_title('Bukin N.6: 3D Projection of Solution Space', fontsize = 15)
...
ax2.set_title('Bukin N.6: Contour Plot of Solution Space', fontsize = 15)
