...
#   './single_objective/beale/graph.py'
...
ax1.set_title('Beale: 3D Projection of Solution Space')
...
ax2.set_xlabel('$x_1$')
ax2.set_ylabel('$x_2$')
ax2.set_title('Beale: Contour Plot of Solution Space')
