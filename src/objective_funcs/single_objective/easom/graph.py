...
#   './single_objective/easom/graph.py'
...
ax1.set_title('Easom: 3D Projection of Solution Space')
...
ax2.set_xlabel('$x_1$')
ax2.set_ylabel('$x_2$')
ax2.set_title('Easom: Contour Plot of Solution Space')
