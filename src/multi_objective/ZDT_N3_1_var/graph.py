...
#   '.src/objective_funcs/multi_objective/ZDT_N3_1_var/graph.py'
...
filename = 'ZDT_N3_1var_pareto_coords_output.csv'
plotname = 'zitzler_deb_thiele_N3_plots_1_var.png'
...
ax1.set_title('ZDT N.3: 1 Input Feasible Decision Space', fontsize = 15)
...
ax2.set_title('ZDT N.3: Pareto Front & Feasible Objective Space', fontsize = 10)
