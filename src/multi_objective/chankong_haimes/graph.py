...
#   './multi_objective/chankong_haimes/graph.py'
...
filename = 'CH_pareto_coords_output.csv'
plotname = 'chankong_haimes_plots.png'
...
ax1.set_title('Chankong and Haimes: Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Chankong and Haimes: Pareto Front & Feasible Objective Space', fontsize = 15)
