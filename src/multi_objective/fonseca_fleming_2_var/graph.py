...
#   '.src/objective_funcs/multi_objective/fonseca_fleming_2_var/graph.py'
...
filename = 'FF2var_pareto_coords_output.csv'
plotname = 'fonseca_fleming_plots_2_var.png'
...
ax1.set_title('Fonseca Fleming: 2 Input Feasible Decision Space', fontsize = 15)
...
ax2.set_xlabel('$f_{1}(x_1,x_2)$', fontsize = 10)
ax2.set_ylabel('$f_{2}(x_1,x_2)$', fontsize = 10)
ax2.set_title('Fonesca Fleming: Pareto Front & Feasible Objective Space', fontsize = 15)
