...
#   '.src/objective_funcs/multi_objective/kursawe_2_var/graph.py'
...
filename = 'K2var_pareto_coords_output.csv'
plotname = 'kursawe_plots_2_var.png'
...
ax1.set_title('Kursawe: 2 Input Feasible Decision Space', fontsize = 15)
