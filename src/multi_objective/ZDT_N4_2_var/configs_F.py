...
#   '.src/objective_funcs/multi_objective/ZDT_N4_2_var/configs_F.py'
...
try: # for outside func calls
    ...
    from objective_funcs.multi_objective.ZDT_N4_2_var.func_F import func_F
    from objective_funcs.multi_objective.ZDT_N4_2_var.constr_F import constr_F
except: # for local
...
OBJECTIVE_FUNC_NAME = "ZDT_N4_2_var.func_F"
CONSTR_FUNC_NAME = "ZDT_N4_2_var.constr_F"
...
TARGETS = [0.0, 1.34240807] # Target values for output, on pareto front
