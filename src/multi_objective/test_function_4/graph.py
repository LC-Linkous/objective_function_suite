...
#   '.src/objective_funcs/multi_objective/test_function_4/graph.py'
...
filename = 'TF4_pareto_coords_output.csv'
plotname = 'test_function_4_plots.png'
...
ax1.set_title('Binh and Korn 4: Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Binh and Korn 4: Pareto Front & Feasible Objective Space', fontsize = 15)
