...
#   '.src/objective_funcs/multi_objective/fonseca_fleming_1_var/graph.py'
...
filename = 'FF1var_pareto_coords_output.csv'
plotname = 'fonseca_fleming_plots_1_var.png'
...
ax1.set_ylabel('filler_values', fontsize = 10)
ax1.set_title('Fonseca Fleming: 1 Input Feasible Decision Space', fontsize = 15)
...
ax2.set_xlabel('$f_{1}(x_1)$', fontsize = 10)
ax2.set_ylabel('$f_{2}(x_1)$', fontsize = 10)
ax2.set_title('Fonseca Fleming: Pareto Front & Feasible Objective Space', fontsize = 15)
