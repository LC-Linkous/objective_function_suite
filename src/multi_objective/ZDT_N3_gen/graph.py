...
#   '.src/objective_funcs/multi_objective/ZDT_N3_gen/graph.py'
...
# The ZDT_N3 function can be used for 1:30 variables.
MIN_DIM = 1
MAX_DIM = 2 #30
NUM_SAMPLES = 2
...
filepath = "ZDT3_pareto_coords_output.csv"
plotname = "ZDT3_output.png"
