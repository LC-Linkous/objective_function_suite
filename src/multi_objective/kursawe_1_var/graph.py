...
#   '.src/objective_funcs/multi_objective/kursawe_1_var/graph.py'
...
filename = 'K1var_pareto_coords_output.csv'
plotname = 'kursawe_plots_1_var.png'
...
ax1.set_title('Kursawe: 1 Input Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Kursawe: Pareto Front & Feasible Objective Space', fontsize = 15)
