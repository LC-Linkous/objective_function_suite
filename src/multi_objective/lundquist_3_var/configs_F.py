...
##--------------------------------------------------------------------\
#   pso_basic
#   '.src/objective_funcs/multi_objective/lundquist_3_var/configs_F.py'
...
try: # for outside func calls
    ...
    from objective_funcs.multi_objective.lundquist_3_var.func_F import func_F
    from objective_funcs.multi_objective.lundquist_3_var.constr_F import constr_F
except: # for local
