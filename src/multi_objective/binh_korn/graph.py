...
#   './multi_objective/binh_korn/graph.py'
...
filename = 'binh_korn_pareto_coords_output.csv'
plotname = 'binh_korn_plots.png'
...
ax1.set_title('Binh and Korn: Feasible Decision Space', fontsize = 15)
...
ax2.set_title('Binh and Korn: Pareto Front & Feasible Objective Space', fontsize = 15)
