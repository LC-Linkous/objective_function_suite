...
#   '.src/objective_funcs/multi_objective/ZDT_N2_gen/graph.py'
...
# The ZDT_N2 function can be used for 1:30 variables.
MIN_DIM = 1
MAX_DIM = 4 #30
NUM_SAMPLES = 4
...
filepath = "ZDT2_pareto_coords_output.csv"
plotname = "ZDT2_output.png"
